...
//  static constexpr float distance_factor = 3.5; //0.65 m 
  static constexpr float distance_factor = 1.341; 
...
void loop() {
  ...
  if (connected) {
    ...
    float distance = get_distance(rssi);
    Serial.println("Setting new characteristic value to \"" + newValue + "\""+" distance: "+distance);
//int rssi= pClient->getRssi();
